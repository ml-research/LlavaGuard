...
# dataset settings
TEMPLATE_VERSION="json-v17" # (json-v0, json-v1, json-v2, json-v3, json-v4, or nl) the version of the template used to generate the data
...
MODEL_OUTPUT_DIR1="/common-repos/LlavaGuard/models/LlavaGuard-v1.1-7b-full/${DS_VERSION2}/${TEMPLATE_VERSION}"

# llavaguard-v1.1 13b model training
MODEL_VERSION2="liuhaotian/llava-v1.5-13b" # the model version to use for training
MODEL_OUTPUT_DIR2="/common-repos/LlavaGuard/models/LlavaGuard-v1.1-13b-full/${DS_VERSION2}/${TEMPLATE_VERSION}"

# llavaguard-v1.2 34b model training
MODEL_VERSION3="liuhaotian/llava-v1.6-34b" # the model version to use for training
MODEL_OUTPUT_DIR3="/common-repos/LlavaGuard/models/LlavaGuard-v1.2-34b-full/${DS_VERSION2}/${TEMPLATE_VERSION}"

data_path="/common-repos/LlavaGuard/data/${DS_VERSION2}/${TEMPLATE_VERSION}"
