...
MODEL_OUTPUT_DIR1="/common-repos/LlavaGuard/models/LlavaGuard-v1.1-34b/${DS_VERSION1}/${TEMPLATE_VERSION}"
MODEL_OUTPUT_DIR2="/common-repos/LlavaGuard/models/LlavaGuard-v1.1-34b/${DS_VERSION2}/${TEMPLATE_VERSION}"
