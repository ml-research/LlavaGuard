...
MODEL_OUTPUT_DIR1="/common-repos/LlavaGuard/models/lora/LlavaGuard-v1.1-7b/${DS_VERSION2}/${TEMPLATE_VERSION}"

# llavaguard-v1.1 13b model training
MODEL_VERSION2="liuhaotian/llava-v1.5-13b" # the model version to use for training
MODEL_OUTPUT_DIR2="/common-repos/LlavaGuard/models/lora/LlavaGuard-v1.1-13b/${DS_VERSION2}/${TEMPLATE_VERSION}"

# llavaguard-v1.2 34b model training
MODEL_VERSION3="liuhaotian/llava-v1.6-34b" # the model version to use for training
MODEL_OUTPUT_DIR3="/common-repos/LlavaGuard/models/lora/LlavaGuard-v1.2-34b/${DS_VERSION2}/${TEMPLATE_VERSION}"
