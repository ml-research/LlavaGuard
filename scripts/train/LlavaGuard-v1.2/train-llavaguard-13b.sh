...
MODEL_VERSION2="liuhaotian/llava-v1.6-vicuna-13b" # the model version to use for training
MODEL_OUTPUT_DIR2="${local_data_dir}/models/LlavaGuard-v1.2-13b/${DS_VERSION2}/${TEMPLATE_VERSION}"
